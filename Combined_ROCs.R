...
setwd("D:/MEWAN B WAR/PhD Coursework IIIT Hyderabad/2nd Semester/GS2.401 - Spatial Informatics/Project/Analysis")

############################### Evaluation of 1st Model: AHP ###################
# Load the dataset
data_ahp <- read_xlsx("ROCs_Combined.xlsx", sheet = 1)
...
# Load the dataset
data_logR <- read_xlsx("ROCs_Combined.xlsx", sheet = 2)
...
# Load the dataset
data_ANN <- read_xlsx("ROCs_Combined.xlsx", sheet = 3)
...
# Load the dataset
data_RF <- read_xlsx("ROCs_Combined.xlsx", sheet = 4)
...
# Instead of multiple plots, I want one single plot in which multiple curves
# and their respective AUC values are overlaid in one layout
